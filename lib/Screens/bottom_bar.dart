...
class _BottomBarState extends State<BottomBar> {
  //making access to the widgets dynamic, by creating a variable.
  int _selectedIndex = 0;
  //creating options to navigate in the bottom bar.
  ...
  //create a method that allows me to navigate easily.
  //using setstate changes the ui of the app.
